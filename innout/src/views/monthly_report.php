...
<main class="content">
	<?php
	setlocale(LC_TIME, 'Brazil', 'pt_BR.uft-8', 'portuguese_brazilian', 'portuguese.utf-8', 'utf-8', 'utf8');
	...
	?>
	<div>
		<form accept-charset="utf-8" class="mb-4" action="#" method="post">
		...
		<a class="btn btn-lg btn-primary mb-3" onClick="window.print()">Imprimir</a>
